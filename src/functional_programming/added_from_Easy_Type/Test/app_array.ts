...
// class ApplicativeArray<T extends {(arg: any): any}[], B extends Parameters<T[0]>[0]> extends Array<T>{
//     private constructor(...args: T) {
//         super(args)
//     }

//     static create<Z extends {(arg: any): any}[]>(...items: Z[]): ApplicativeArray<Z, Parameters<Z[0]>[0]> {
...
//     }
//     ap<R extends ReturnType<T[0]>>(xs: B[]) {
//         return this.reduce((acc: R[], currentFn: T) => acc.concat(xs.map(currentFn)), [])
//     }

// };

// let appArray = ApplicativeArray.create(a => 2 + a);
